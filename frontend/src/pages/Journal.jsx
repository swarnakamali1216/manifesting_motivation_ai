...
var MOODS = [
  { key:"amazing",  emoji:"ÃƒÂ°Ã…Â¸Ã…â€™Ã…Â¸", label:"Amazing",   color:"#fbbf24", bg:"rgba(251,191,36,0.12)"  },
  { key:"good",     emoji:"ÃƒÂ°Ã…Â¸Ã‹Å“Ã…Â ", label:"Good",      color:"#4ade80", bg:"rgba(74,222,128,0.12)"  },
  { key:"okay",     emoji:"ÃƒÂ°Ã…Â¸Ã‹Å“Ã‚Â", label:"Okay",      color:"#60a5fa", bg:"rgba(96,165,250,0.12)"  },
  { key:"low",      emoji:"ÃƒÂ°Ã…Â¸Ã‹Å“Ã¢â‚¬Â", label:"Low",       color:"#a78bfa", bg:"rgba(167,139,250,0.12)" },
  { key:"anxious",  emoji:"ÃƒÂ°Ã…Â¸Ã‹Å“Ã‚Â°", label:"Anxious",   color:"#fb923c", bg:"rgba(251,146,60,0.12)"  },
  { key:"grateful", emoji:"ÃƒÂ°Ã…Â¸Ã¢â€žÂ¢Ã‚Â", label:"Grateful",  color:"#34d399", bg:"rgba(52,211,153,0.12)"  },
  { key:"angry",    emoji:"ÃƒÂ°Ã…Â¸Ã‹Å“Ã‚Â¤", label:"Frustrated",color:"#f87171", bg:"rgba(248,113,113,0.12)" },
  { key:"excited",  emoji:"ÃƒÂ¢Ã…Â¡Ã‚Â¡", label:"Excited",   color:"#c084fc", bg:"rgba(192,132,252,0.12)" },
];
...
// ÃƒÂ¢Ã¢â‚¬ÂÃ¢â€šÂ¬ÃƒÂ¢Ã¢â‚¬ÂÃ¢â€šÂ¬ Mood Streak ÃƒÂ¢Ã¢â‚¬ÂÃ¢â€šÂ¬ÃƒÂ¢Ã¢â‚¬ÂÃ¢â€šÂ¬ÃƒÂ¢Ã¢â‚¬ÂÃ¢â€šÂ¬ÃƒÂ¢Ã¢â‚¬ÂÃ¢â€šÂ¬ÃƒÂ¢Ã¢â‚¬ÂÃ¢â€šÂ¬ÃƒÂ¢Ã¢â‚¬ÂÃ¢â€šÂ¬ÃƒÂ¢Ã¢â‚¬ÂÃ¢â€šÂ¬ÃƒÂ¢Ã¢â‚¬ÂÃ¢â€šÂ¬ÃƒÂ¢Ã¢â‚¬ÂÃ¢â€šÂ¬ÃƒÂ¢Ã¢â‚¬ÂÃ¢â€šÂ¬ÃƒÂ¢Ã¢â‚¬ÂÃ¢â€šÂ¬ÃƒÂ¢Ã¢â‚¬ÂÃ¢â€šÂ¬ÃƒÂ¢Ã¢â‚¬ÂÃ¢â€šÂ¬ÃƒÂ¢Ã¢â‚¬ÂÃ¢â€šÂ¬ÃƒÂ¢Ã¢â‚¬ÂÃ¢â€šÂ¬ÃƒÂ¢Ã¢â‚¬ÂÃ¢â€šÂ¬ÃƒÂ¢Ã¢â‚¬ÂÃ¢â€šÂ¬ÃƒÂ¢Ã¢â‚¬ÂÃ¢â€šÂ¬ÃƒÂ¢Ã¢â‚¬ÂÃ¢â€šÂ¬ÃƒÂ¢Ã¢â‚¬ÂÃ¢â€šÂ¬ÃƒÂ¢Ã¢â‚¬ÂÃ¢â€šÂ¬ÃƒÂ¢Ã¢â‚¬ÂÃ¢â€šÂ¬ÃƒÂ¢Ã¢â‚¬ÂÃ¢â€šÂ¬ÃƒÂ¢Ã¢â‚¬ÂÃ¢â€šÂ¬ÃƒÂ¢Ã¢â‚¬ÂÃ¢â€šÂ¬ÃƒÂ¢Ã¢â‚¬ÂÃ¢â€šÂ¬ÃƒÂ¢Ã¢â‚¬ÂÃ¢â€šÂ¬ÃƒÂ¢Ã¢â‚¬ÂÃ¢â€šÂ¬ÃƒÂ¢Ã¢â‚¬ÂÃ¢â€šÂ¬ÃƒÂ¢Ã¢â‚¬ÂÃ¢â€šÂ¬ÃƒÂ¢Ã¢â‚¬ÂÃ¢â€šÂ¬ÃƒÂ¢Ã¢â‚¬ÂÃ¢â€šÂ¬ÃƒÂ¢Ã¢â‚¬ÂÃ¢â€šÂ¬ÃƒÂ¢Ã¢â‚¬ÂÃ¢â€šÂ¬ÃƒÂ¢Ã¢â‚¬ÂÃ¢â€šÂ¬ÃƒÂ¢Ã¢â‚¬ÂÃ¢â€šÂ¬ÃƒÂ¢Ã¢â‚¬ÂÃ¢â€šÂ¬ÃƒÂ¢Ã¢â‚¬ÂÃ¢â€šÂ¬ÃƒÂ¢Ã¢â‚¬ÂÃ¢â€šÂ¬ÃƒÂ¢Ã¢â‚¬ÂÃ¢â€šÂ¬ÃƒÂ¢Ã¢â‚¬ÂÃ¢â€šÂ¬ÃƒÂ¢Ã¢â‚¬ÂÃ¢â€šÂ¬ÃƒÂ¢Ã¢â‚¬ÂÃ¢â€šÂ¬ÃƒÂ¢Ã¢â‚¬ÂÃ¢â€šÂ¬ÃƒÂ¢Ã¢â‚¬ÂÃ¢â€šÂ¬ÃƒÂ¢Ã¢â‚¬ÂÃ¢â€šÂ¬ÃƒÂ¢Ã¢â‚¬ÂÃ¢â€šÂ¬
...
// ÃƒÂ¢Ã¢â‚¬ÂÃ¢â€šÂ¬ÃƒÂ¢Ã¢â‚¬ÂÃ¢â€šÂ¬ Entry Card ÃƒÂ¢Ã¢â‚¬ÂÃ¢â€šÂ¬ÃƒÂ¢Ã¢â‚¬ÂÃ¢â€šÂ¬ÃƒÂ¢Ã¢â‚¬ÂÃ¢â€šÂ¬ÃƒÂ¢Ã¢â‚¬ÂÃ¢â€šÂ¬ÃƒÂ¢Ã¢â‚¬ÂÃ¢â€šÂ¬ÃƒÂ¢Ã¢â‚¬ÂÃ¢â€šÂ¬ÃƒÂ¢Ã¢â‚¬ÂÃ¢â€šÂ¬ÃƒÂ¢Ã¢â‚¬ÂÃ¢â€šÂ¬ÃƒÂ¢Ã¢â‚¬ÂÃ¢â€šÂ¬ÃƒÂ¢Ã¢â‚¬ÂÃ¢â€šÂ¬ÃƒÂ¢Ã¢â‚¬ÂÃ¢â€šÂ¬ÃƒÂ¢Ã¢â‚¬ÂÃ¢â€šÂ¬ÃƒÂ¢Ã¢â‚¬ÂÃ¢â€šÂ¬ÃƒÂ¢Ã¢â‚¬ÂÃ¢â€šÂ¬ÃƒÂ¢Ã¢â‚¬ÂÃ¢â€šÂ¬ÃƒÂ¢Ã¢â‚¬ÂÃ¢â€šÂ¬ÃƒÂ¢Ã¢â‚¬ÂÃ¢â€šÂ¬ÃƒÂ¢Ã¢â‚¬ÂÃ¢â€šÂ¬ÃƒÂ¢Ã¢â‚¬ÂÃ¢â€šÂ¬ÃƒÂ¢Ã¢â‚¬ÂÃ¢â€šÂ¬ÃƒÂ¢Ã¢â‚¬ÂÃ¢â€šÂ¬ÃƒÂ¢Ã¢â‚¬ÂÃ¢â€šÂ¬ÃƒÂ¢Ã¢â‚¬ÂÃ¢â€šÂ¬ÃƒÂ¢Ã¢â‚¬ÂÃ¢â€šÂ¬ÃƒÂ¢Ã¢â‚¬ÂÃ¢â€šÂ¬ÃƒÂ¢Ã¢â‚¬ÂÃ¢â€šÂ¬ÃƒÂ¢Ã¢â‚¬ÂÃ¢â€šÂ¬ÃƒÂ¢Ã¢â‚¬ÂÃ¢â€šÂ¬ÃƒÂ¢Ã¢â‚¬ÂÃ¢â€šÂ¬ÃƒÂ¢Ã¢â‚¬ÂÃ¢â€šÂ¬ÃƒÂ¢Ã¢â‚¬ÂÃ¢â€šÂ¬ÃƒÂ¢Ã¢â‚¬ÂÃ¢â€šÂ¬ÃƒÂ¢Ã¢â‚¬ÂÃ¢â€šÂ¬ÃƒÂ¢Ã¢â‚¬ÂÃ¢â€šÂ¬ÃƒÂ¢Ã¢â‚¬ÂÃ¢â€šÂ¬ÃƒÂ¢Ã¢â‚¬ÂÃ¢â€šÂ¬ÃƒÂ¢Ã¢â‚¬ÂÃ¢â€šÂ¬ÃƒÂ¢Ã¢â‚¬ÂÃ¢â€šÂ¬ÃƒÂ¢Ã¢â‚¬ÂÃ¢â€šÂ¬ÃƒÂ¢Ã¢â‚¬ÂÃ¢â€šÂ¬ÃƒÂ¢Ã¢â‚¬ÂÃ¢â€šÂ¬ÃƒÂ¢Ã¢â‚¬ÂÃ¢â€šÂ¬ÃƒÂ¢Ã¢â‚¬ÂÃ¢â€šÂ¬ÃƒÂ¢Ã¢â‚¬ÂÃ¢â€šÂ¬ÃƒÂ¢Ã¢â‚¬ÂÃ¢â€šÂ¬ÃƒÂ¢Ã¢â‚¬ÂÃ¢â€šÂ¬ÃƒÂ¢Ã¢â‚¬ÂÃ¢â€šÂ¬ÃƒÂ¢Ã¢â‚¬ÂÃ¢â€šÂ¬
        ...
        <div style={{ display:"flex", alignItems:"center", gap:"10px" }}>
          ...
          <div>
            ...
            <div style={{ display:"flex", alignItems:"center", gap:"6px", marginTop:"2px" }}>
              ...
              <span style={{ fontSize:"10px", color:"var(--muted)" }}>Ãƒâ€šÃ‚Â·</span>
      ...
      <div style={{ padding:"0 14px 12px" }}>
        ...
        {isLong && (
          <button onClick={function(){ setExpanded(function(v){return !v;}); }}
            ...
            {expanded ? "Show less ÃƒÂ¢Ã¢â‚¬Â Ã¢â‚¬Ëœ" : "Read more ÃƒÂ¢Ã¢â‚¬Â Ã¢â‚¬Å“"}
          </button>
        )}
      </div>
...
// ÃƒÂ¢Ã¢â‚¬ÂÃ¢â€šÂ¬ÃƒÂ¢Ã¢â‚¬ÂÃ¢â€šÂ¬ Write / Edit Modal ÃƒÂ¢Ã¢â‚¬ÂÃ¢â€šÂ¬ÃƒÂ¢Ã¢â‚¬ÂÃ¢â€šÂ¬ÃƒÂ¢Ã¢â‚¬ÂÃ¢â€šÂ¬ÃƒÂ¢Ã¢â‚¬ÂÃ¢â€šÂ¬ÃƒÂ¢Ã¢â‚¬ÂÃ¢â€šÂ¬ÃƒÂ¢Ã¢â‚¬ÂÃ¢â€šÂ¬ÃƒÂ¢Ã¢â‚¬ÂÃ¢â€šÂ¬ÃƒÂ¢Ã¢â‚¬ÂÃ¢â€šÂ¬ÃƒÂ¢Ã¢â‚¬ÂÃ¢â€šÂ¬ÃƒÂ¢Ã¢â‚¬ÂÃ¢â€šÂ¬ÃƒÂ¢Ã¢â‚¬ÂÃ¢â€šÂ¬ÃƒÂ¢Ã¢â‚¬ÂÃ¢â€šÂ¬ÃƒÂ¢Ã¢â‚¬ÂÃ¢â€šÂ¬ÃƒÂ¢Ã¢â‚¬ÂÃ¢â€šÂ¬ÃƒÂ¢Ã¢â‚¬ÂÃ¢â€šÂ¬ÃƒÂ¢Ã¢â‚¬ÂÃ¢â€šÂ¬ÃƒÂ¢Ã¢â‚¬ÂÃ¢â€šÂ¬ÃƒÂ¢Ã¢â‚¬ÂÃ¢â€šÂ¬ÃƒÂ¢Ã¢â‚¬ÂÃ¢â€šÂ¬ÃƒÂ¢Ã¢â‚¬ÂÃ¢â€šÂ¬ÃƒÂ¢Ã¢â‚¬ÂÃ¢â€šÂ¬ÃƒÂ¢Ã¢â‚¬ÂÃ¢â€šÂ¬ÃƒÂ¢Ã¢â‚¬ÂÃ¢â€šÂ¬ÃƒÂ¢Ã¢â‚¬ÂÃ¢â€šÂ¬ÃƒÂ¢Ã¢â‚¬ÂÃ¢â€šÂ¬ÃƒÂ¢Ã¢â‚¬ÂÃ¢â€šÂ¬ÃƒÂ¢Ã¢â‚¬ÂÃ¢â€šÂ¬ÃƒÂ¢Ã¢â‚¬ÂÃ¢â€šÂ¬ÃƒÂ¢Ã¢â‚¬ÂÃ¢â€šÂ¬ÃƒÂ¢Ã¢â‚¬ÂÃ¢â€šÂ¬ÃƒÂ¢Ã¢â‚¬ÂÃ¢â€šÂ¬ÃƒÂ¢Ã¢â‚¬ÂÃ¢â€šÂ¬ÃƒÂ¢Ã¢â‚¬ÂÃ¢â€šÂ¬ÃƒÂ¢Ã¢â‚¬ÂÃ¢â€šÂ¬ÃƒÂ¢Ã¢â‚¬ÂÃ¢â€šÂ¬ÃƒÂ¢Ã¢â‚¬ÂÃ¢â€šÂ¬ÃƒÂ¢Ã¢â‚¬ÂÃ¢â€šÂ¬ÃƒÂ¢Ã¢â‚¬ÂÃ¢â€šÂ¬ÃƒÂ¢Ã¢â‚¬ÂÃ¢â€šÂ¬ÃƒÂ¢Ã¢â‚¬ÂÃ¢â€šÂ¬
function WriteModal({ user, editEntry, onClose, onSaved }) {
  ...
  }, [isEdit]); // ÃƒÂ¢Ã…â€œÃ¢â‚¬Â¦ add isEdit here
  ...
  function save() {
    ...
    req.then(function(){
      ...
      console.error(e);
      alert("Save failed ÃƒÂ¢Ã¢â€šÂ¬Ã¢â‚¬Â check Flask terminal");
      ...
      <div style={{
        ...
        <div style={{ padding:"16px 20px 12px", display:"flex", alignItems:"center", justifyContent:"space-between", borderBottom:"1px solid var(--border)" }}>
          <div style={{ fontFamily:"'Syne',sans-serif", fontWeight:"900", fontSize:"16px", color:"var(--text)" }}>
            {isEdit ? "ÃƒÂ¢Ã…â€œÃ‚ÂÃƒÂ¯Ã‚Â¸Ã‚Â Edit Entry" : "ÃƒÂ¢Ã…â€œÃ‚ÂÃƒÂ¯Ã‚Â¸Ã‚Â New Entry"}
          </div>
          <div style={{ display:"flex", gap:"8px", alignItems:"center" }}>
            <span style={{ fontSize:"10px", color:"var(--muted)" }}>{wordCount(content)} words</span>
            <button onClick={onClose} style={{ background:"none", border:"none", color:"var(--muted)", fontSize:"18px", cursor:"pointer", lineHeight:1 }}>ÃƒÆ’Ã¢â‚¬â€</button>
          </div>
        </div>
        ...
        <div style={{ overflowY:"auto", flex:1, padding:"16px 20px" }}>
          {!isEdit && prompt && (
            <div style={{ background:"rgba(124,92,252,0.06)", border:"1px solid rgba(124,92,252,0.15)", borderRadius:"12px", padding:"10px 14px", marginBottom:"14px", cursor:"pointer" }}
              ...
              <div style={{ fontSize:"9px", color:"var(--accent)", fontWeight:"800", fontFamily:"'Syne',sans-serif", marginBottom:"3px" }}>ÃƒÂ°Ã…Â¸Ã¢â‚¬â„¢Ã‚Â¡ TODAY'S PROMPT ÃƒÂ¢Ã¢â€šÂ¬Ã¢â‚¬Â tap to use</div>
          ...
          <textarea
            ref={textRef}
            placeholder={"Write freely... your thoughts are safe here.\n\nThis is your private space ÃƒÂ¢Ã¢â€šÂ¬Ã¢â‚¬Â be honest with yourself."}
            value={content}
        ...
        <div style={{ padding:"12px 20px", borderTop:"1px solid var(--border)", display:"flex", justifyContent:"space-between", alignItems:"center", background:"var(--surface)" }}>
          <div style={{ fontSize:"10px", color:"var(--muted)", display:"flex", alignItems:"center", gap:"5px" }}>
            ÃƒÂ°Ã…Â¸Ã¢â‚¬ÂÃ¢â‚¬â„¢ <span>Private & encrypted ÃƒÂ¢Ã¢â€šÂ¬Ã¢â‚¬Â only you can see this</span>
          </div>
          <div style={{ display:"flex", gap:"8px" }}>
            ...
            <button onClick={save} disabled={saving||!content.trim()}
              ...
              {saving ? "Saving..." : isEdit ? "Update ÃƒÂ¢Ã…â€œÃ¢â‚¬Å“" : "Save Entry ÃƒÂ¢Ã…â€œÃ¢â‚¬Å“"}
            </button>
          </div>
        </div>
      </div>
    ...
    <div style={{ animation:"fadeIn 0.3s ease", paddingBottom:"24px" }}>
      ...
      <div style={{ marginBottom:"16px" }}>
        <div style={{ display:"flex", alignItems:"flex-start", justifyContent:"space-between", marginBottom:"4px" }}>
          ...
          <button onClick={handleNew}
            ...
            ÃƒÂ¢Ã…â€œÃ‚ÂÃƒÂ¯Ã‚Â¸Ã‚Â Write
          </button>
        </div>
        <div style={{ display:"inline-flex", alignItems:"center", gap:"5px", background:"rgba(74,222,128,0.08)", border:"1px solid rgba(74,222,128,0.2)", borderRadius:"8px", padding:"4px 10px", marginTop:"4px" }}>
          <span style={{ fontSize:"10px" }}>ÃƒÂ°Ã…Â¸Ã¢â‚¬ÂÃ¢â‚¬â„¢</span>
          <span style={{ fontSize:"10px", color:"#4ade80", fontWeight:"700", fontFamily:"'Syne',sans-serif" }}>Private & Secure ÃƒÂ¢Ã¢â€šÂ¬Ã¢â‚¬Â only you can read this</span>
        </div>
      </div>
      ...
      {entries.length > 0 && (
        <div style={{ display:"grid", gridTemplateColumns:"repeat(4,1fr)", gap:"8px", marginBottom:"14px" }}>
          {[
            { v:posCount,       l:"Positive",   c:"#4ade80", e:"ÃƒÂ°Ã…Â¸Ã‹Å“Ã…Â " },
            { v:toughCount,     l:"Tough",       c:"#f87171", e:"ÃƒÂ°Ã…Â¸Ã¢â‚¬â„¢Ã‚Âª" },
            { v:streakDays+"d", l:"Streak",      c:"#fb923c", e:"ÃƒÂ°Ã…Â¸Ã¢â‚¬ÂÃ‚Â¥" },
            { v:totalWords,     l:"Words",       c:"#60a5fa", e:"ÃƒÂ¢Ã…â€œÃ‚ÂÃƒÂ¯Ã‚Â¸Ã‚Â" },
          ].map(function(s){
            return (
      ...
      {entries.length > 0 && (
        <div style={{ marginBottom:"12px", display:"flex", flexDirection:"column", gap:"8px" }}>
          <input
            className="j-input"
            placeholder="ÃƒÂ°Ã…Â¸Ã¢â‚¬ÂÃ‚Â Search entries..."
            value={search}
          ...
          <div style={{ display:"flex", gap:"6px", overflowX:"auto", paddingBottom:"2px" }}>
            ...
            <button onClick={function(){ setSortDir(function(v){return v==="desc"?"asc":"desc";}); }}
              ...
              {sortDir==="desc"?"ÃƒÂ¢Ã¢â‚¬Â Ã¢â‚¬Å“ Newest":"ÃƒÂ¢Ã¢â‚¬Â Ã¢â‚¬Ëœ Oldest"}
            </button>
          </div>
      ...
      {loading ? (
        ...
        <div style={{ textAlign:"center", padding:"48px 20px", background:"var(--card)", borderRadius:"20px", border:"1px solid var(--border)" }}>
          <div style={{ fontSize:"48px", marginBottom:"12px" }}>ÃƒÂ°Ã…Â¸Ã¢â‚¬Å“Ã¢â‚¬â€œ</div>
          ...
          <button onClick={handleNew}
            ...
            ÃƒÂ¢Ã…â€œÃ‚ÂÃƒÂ¯Ã‚Â¸Ã‚Â Write Your First Entry
          </button>
        </div>
      ) : filtered.length === 0 ? (
