...
path = os.path.join("backend", "routes", "predictor.py")
...
lines = len(check.split("\n"))
print("File lines:", lines)
print("Has user_id sessions filter:", "motivation_sessions WHERE user_id" in check)
print("Has combined mood:", "tot_pos" in check)
print("Has streak bonus:", "streak_bonus" in check)
print("Has debug logging:", "[predictor]" in check)
print("Has NO verify code:", "checks = [" not in check)
print("Line 188 area:", check.split("\n")[185:188] if lines > 185 else "less than 188 lines")